...
def assert_excel_content(test_case: unittest.TestCase, actual_content: bytes, expected_file_path: str):
    import xlrd
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        test_case.assertCountEqual(actual_workbook.sheet_names(), expected_workbook.sheet_names())
...
def _assert_sheet_content(test_case: unittest.TestCase, actual_worksheet, expected_worksheet):
...
class JSONTestCase(TestCase):
    ...
    def assert_excel_content(self, actual_content: bytes, expected_file_path: str):
        warnings.warn("Deprecated function use assert_excel_content function")
        assert_excel_content(self, actual_content, expected_file_path)

    def assert_excel_file(self, response, expected_file_path: str):
        assert_excel_content(self, response.data, expected_file_path)
