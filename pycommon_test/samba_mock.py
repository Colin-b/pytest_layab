...
class TestConnection:
    ...
    def rename(
        ...
        TestConnection.stored_files[
            (share_drive_path, new_file_path)
        ] = TestConnection.stored_files.pop((share_drive_path, initial_file_path), None)

    def retrieveFile(self, share_drive_path: str, file_path: str, file) -> (int, int):
        retrieved_file_content = TestConnection.files_to_retrieve.pop(
