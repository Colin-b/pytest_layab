...
from pycommon_test import service_tester, adam_mock, celery_mock
...
class CeleryMockTest(service_tester.JSONTestCase):
    def create_app(self):
        ...
        def test_celery_async():
            celery_task = method_to_call.apply_async(args=(1, 'a', 'b'), kwargs={'c':'c1', 'd':'d1'})
    ...
    def test_celery_task_call_sync(self):
        ...
        self.assert_200(response)
        self.assert_json(response, {'args': ['a', 'b'], 'c': 'c1', 'd': 'd1', 'param1': 1})
